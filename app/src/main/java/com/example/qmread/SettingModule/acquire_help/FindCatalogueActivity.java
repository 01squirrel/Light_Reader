...
import com.example.qmread.databinding.ActivityFindCatalogueBinding;
import com.google.android.material.button.MaterialButton;

public class FindCatalogueActivity extends AppCompatActivity {

    ActivityFindCatalogueBinding binding;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFindCatalogueBinding.inflate(getLayoutInflater());
