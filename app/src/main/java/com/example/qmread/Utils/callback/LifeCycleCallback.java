...
public class LifeCycleCallback implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityCreated(Activity activity, Bundle bundle) {
            Log.i("created======","onActivityCreated" + getActivityName(activity));
        }
        ...
        public void onActivityResumed(Activity activity) {
            Log.i("resume======","onActivityResumed" + getActivityName(activity));
            ...
            if (willSwitchToForeground && isInteractive(activity)) {
                ...
                Log.i("back=====","switch to foreground");
            }
            if (isForegroundNow) {
        ...
        public void onActivityPaused(Activity activity) {
            Log.i("pause======","onActivityPaused" + getActivityName(activity));
        ...
        public void onActivityStopped(Activity activity) {
            ...
            if (foregroundActivityCount == 0) {
                ...
                Log.i("msg======","switch to background (reduce time[" + appUseReduceTime + "])");
...
//            }else {
                ...
                saveTodayPlayTime(activity, runTimeThisDay);
                lastCheckTime = System.currentTimeMillis();
                Log.i("day======","run time  :" + runTimeThisDay);
            }
        }

        @Override
        public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
            Log.i("save======","onActivitySaveInstanceState" + getActivityName(activity));
        }
        ...
        public void onActivityDestroyed(Activity activity) {
            ...
            saveTodayPlayTime(activity, runTimeThisDay);
            lastCheckTime = System.currentTimeMillis();
            Log.i("run=====","onActivityDestroyed" + getActivityName(activity) + "--runTimeThisDay:" + runTimeThisDay + "--lastCheckTime" + lastCheckTime);
        }
