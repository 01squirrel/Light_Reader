...
public class BaseRequest {
    ...
    Retrofit retrofit=new Retrofit.Builder().
            ...
            baseUrl(HttpUtil.ApiServise.HOST).
            client(client)                                                  //设置客户端okhttp相关参数
            .build();


    public static BaseRequest instance;
    public HttpUtil.ApiServise apiServise=retrofit.create(HttpUtil.ApiServise.class);         //经过retrofit的实例,获取ApiServise接口的实例
    ...
    public HttpUtil.ApiServise getApiServise(){
        return apiServise;
    }
}
